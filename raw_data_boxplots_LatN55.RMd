...
```{r}
Min_A <- LatN55$X200[1]
Perc25_A <- LatN55$X200[2]
Med_A <- LatN55$X200[3]
Perc75_A <- LatN55$X200[4]
Max_A <- LatN55$X200[5]
Mean_A <- LatN55$X200[6]

Min_B <- LatN55$X250[1]
Perc25_B <- LatN55$X250[2]
Med_B <- LatN55$X250[3]
Perc75_B <- LatN55$X250[4]
Max_B <- LatN55$X250[5]
Mean_B <- LatN55$X250[6]

Min_C <- LatN55$X300[1]
Perc25_C <- LatN55$X300[2]
Med_C <- LatN55$X300[3]
Perc75_C <- LatN55$X300[4]
Max_C <- LatN55$X300[5]
Mean_C <- LatN55$X300[6]

Min_D <- LatN55$X350[1]
Perc25_D <- LatN55$X350[2]
Med_D <- LatN55$X350[3]
Perc75_D <- LatN55$X350[4]
Max_D <- LatN55$X350[5]
Mean_D <- LatN55$X350[6]

Min_E <- LatN55$X400[1]
Perc25_E <- LatN55$X400[2]
Med_E <- LatN55$X400[3]
Perc75_E <- LatN55$X400[4]
Max_E <- LatN55$X400[5]
Mean_E <- LatN55$X400[6]

Min_F <- LatN55$X450[1]
Perc25_F <- LatN55$X450[2]
Med_F <- LatN55$X450[3]
Perc75_F <- LatN55$X450[4]
Max_F <- LatN55$X450[5]
Mean_F <- LatN55$X450[6]

Min_G <- LatN55$X500[1]
Perc25_G <- LatN55$X500[2]
Med_G <- LatN55$X500[3]
Perc75_G <- LatN55$X500[4]
Max_G <- LatN55$X500[5]
Mean_G <- LatN55$X500[6]

Min_H <- LatN55$X550[1]
Perc25_H <- LatN55$X550[2]
Med_H <- LatN55$X550[3]
Perc75_H <- LatN55$X550[4]
Max_H <- LatN55$X550[5]
Mean_H <- LatN55$X550[6]

Min_I <- LatN55$X600[1]
Perc25_I <- LatN55$X600[2]
Med_I <- LatN55$X600[3]
Perc75_I <- LatN55$X600[4]
Max_I <- LatN55$X600[5]
Mean_I <- LatN55$X600[6]

Min_J <- LatN55$X650[1]
Perc25_J <- LatN55$X650[2]
Med_J <- LatN55$X650[3]
Perc75_J <- LatN55$X650[4]
Max_J <- LatN55$X650[5]
Mean_J <- LatN55$X650[6]

Min_K <- LatN55$X700[1]
Perc25_K <- LatN55$X700[2]
Med_K <- LatN55$X700[3]
Perc75_K <- LatN55$X700[4]
Max_K <- LatN55$X700[5]
Mean_K <- LatN55$X700[6]
```
...
ggplot(data_ggplot2_b,                             # Draw multiple ggplot2 boxplots
  ...
  scale_colour_manual(values = "grey32") +
      coord_cartesian(ylim=c(0, 2e+05), clip= 'on') +
