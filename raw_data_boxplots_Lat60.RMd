...
```{r}
Min_A <- Lat60$X200[1]
Perc25_A <- Lat60$X200[2]
Med_A <- Lat60$X200[3]
Perc75_A <- Lat60$X200[4]
Max_A <- Lat60$X200[5]
Mean_A <- Lat60$X200[6]

Min_B <- Lat60$X250[1]
Perc25_B <- Lat60$X250[2]
Med_B <- Lat60$X250[3]
Perc75_B <- Lat60$X250[4]
Max_B <- Lat60$X250[5]
Mean_B <- Lat60$X250[6]

Min_C <- Lat60$X300[1]
Perc25_C <- Lat60$X300[2]
Med_C <- Lat60$X300[3]
Perc75_C <- Lat60$X300[4]
Max_C <- Lat60$X300[5]
Mean_C <- Lat60$X300[6]

Min_D <- Lat60$X350[1]
Perc25_D <- Lat60$X350[2]
Med_D <- Lat60$X350[3]
Perc75_D <- Lat60$X350[4]
Max_D <- Lat60$X350[5]
Mean_D <- Lat60$X350[6]

Min_E <- Lat60$X400[1]
Perc25_E <- Lat60$X400[2]
Med_E <- Lat60$X400[3]
Perc75_E <- Lat60$X400[4]
Max_E <- Lat60$X400[5]
Mean_E <- Lat60$X400[6]

Min_F <- Lat60$X450[1]
Perc25_F <- Lat60$X450[2]
Med_F <- Lat60$X450[3]
Perc75_F <- Lat60$X450[4]
Max_F <- Lat60$X450[5]
Mean_F <- Lat60$X450[6]

Min_G <- Lat60$X500[1]
Perc25_G <- Lat60$X500[2]
Med_G <- Lat60$X500[3]
Perc75_G <- Lat60$X500[4]
Max_G <- Lat60$X500[5]
Mean_G <- Lat60$X500[6]

Min_H <- Lat60$X550[1]
Perc25_H <- Lat60$X550[2]
Med_H <- Lat60$X550[3]
Perc75_H <- Lat60$X550[4]
Max_H <- Lat60$X550[5]
Mean_H <- Lat60$X550[6]

Min_I <- Lat60$X600[1]
Perc25_I <- Lat60$X600[2]
Med_I <- Lat60$X600[3]
Perc75_I <- Lat60$X600[4]
Max_I <- Lat60$X600[5]
Mean_I <- Lat60$X600[6]

Min_J <- Lat60$X650[1]
Perc25_J <- Lat60$X650[2]
Med_J <- Lat60$X650[3]
Perc75_J <- Lat60$X650[4]
Max_J <- Lat60$X650[5]
Mean_J <- Lat60$X650[6]

Min_K <- Lat60$X700[1]
Perc25_K <- Lat60$X700[2]
Med_K <- Lat60$X700[3]
Perc75_K <- Lat60$X700[4]
Max_K <- Lat60$X700[5]
Mean_K <- Lat60$X700[6]
```
