...
# produce plots of sensitivity - NOTE that this script will produce plots that are not impacted by the LVF's spectral response function! To fix this, take the LVF_Data_JAC.csv files that are produced by this script and feed them through the Filter model, then fill out the Flux_sheet.csv with the post-filter flux values and feed it through Filtered_JAC_v2.Rmd
...
png(filename = "GB_B100J_N.png", width = 4800, height = 4800, pointsize = 1, res = 300)
